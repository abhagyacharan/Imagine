        ...
        <motion.div
            ...
            <div className='flex flex-col items-center gap-5 md:gap-14 md:flex-row'>
                ...
                <div>
                    ...
                    <p className='text-gray-600'>Simply type in a text prompt, and our cutting-edge technology will
                        generate high-quality images in seconds. From product visuals to character
                        designs and portraits, even concepts that don't yet exist can be visualized
